        ...
        <div class="compoent-chat-hadder mb-2">
            <div class="btn-group dropend">
                ...
                <div class=" dropdown-menu ">
                    <p class="px-3 text-white pb-3 text-center fs-6">{{ trans('site.Please fill out the form below and we will get back to you as soon as possible') }}.</p>
                    <form class="row  g-2 mx-0 pt-4 px-2 needs-validation form-index-form pb-3" novalidate="">
                        <div class="col-md-12">
                            <input type="text" class="form-control" placeholder="{{ trans('site.name') }}" id="validationCustom01" required="">
                            <div class="valid-feedback">
                                {{ trans('site.Looks Good') }}!
                            </div>
                            <div class="invalid-feedback">
                                {{ trans('site.Please choose a username') }}.
                            </div>
                        </div>
                        <div class="col-md-12">
                            <input type="email" class="form-control" placeholder="{{ trans('site.email') }}" id="validationCustom02" required="">
                            <div class="valid-feedback">
                                {{ trans('site.Looks Good') }}!
                            </div>
                            <div class="invalid-feedback">
                                {{ trans('site.Please choose an email') }}.
                            </div>
                        </div>
                        <div class="col-md-12">
                            <input type="text" class="form-control" placeholder="{{ trans('site.phone') }}" id="validationCustom03" required="">
                            <div class="valid-feedback">
                                {{ trans('site.Looks Good') }}!
                            </div>
                            <div class="invalid-feedback">
                                {{ trans('site.Please choose a phone') }}.
                            </div>
                        </div>
                        <div class="col-md-12">
                            <textarea rows="3" class="form-control" placeholder="{{ trans('site.details') }}" required=""></textarea>
                        </div>
