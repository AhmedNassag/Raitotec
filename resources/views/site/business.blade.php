        ...
        <div class="component-content-or mt-5">
            ...
            <div class="component-or p-4 mt-5">
                ...
                <div class="row mx-0 row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 pt-4 pb-4">
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/stations.webp') }}" alt="ststions">
                    </div>
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/stations.webp') }}" alt="ststions">
                    </div>
                ...
                <div class="row mx-0 row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 pt-4 pb-4">
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/bolog4.webp') }}" alt="web">
                    </div>
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/bolog4.webp') }}" alt="web">
                    </div>
                ...
                <div class="row mx-0 row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 pt-4 pb-4">
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/wep-mopile.webp') }}" alt="web">
                    </div>
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/wep-mopile.webp') }}" alt="web">
                    </div>
                ...
                <div class="row mx-0 row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 pt-4 pb-4">
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/management system.webp') }}" alt="management">
                    </div>
                    <div class="col">
                        <img class="img-or" src="{{ asset('public/assets_site/img/management system.webp') }}" alt="management">
                    </div>
