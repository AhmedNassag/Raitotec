...
<html lang="ar" dir="rtl">
  <head>
      ...
      <meta name="author" content="Hadeer Hussein & Ahmed Nabil">
              ...
              <div class="row mx-0 row-cols-lg-2 row-cols-1 row-login">
                  ...
                  <div class="col pt-5">
                      <div class="mx-auto text-center">
                          <a href="index.html">
                              <img class="logo-login" src="{{ asset('public/assets_site/img/logoar.webp') }}" alt="logo" loading="lazy">
                          </a>
                  ...
                  <div class="col px-0">
                      <img class="w-100 img-login" src="{{ asset('public/assets_site/img/login.png') }}" alt="login" loading="lazy">
