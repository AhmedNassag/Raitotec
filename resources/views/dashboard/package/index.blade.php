...
@section('content')
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
                <h3 class="page-title">{{ trans('main.Packages') }}</h3>
                <ul class="breadcrumb">
	...
	<!-- Search Filter -->
    <div class="card filter-card" id="filter_inputs" @if($name || $price || $discount || $from_date || $to_date) style="display:block" @endif>
        <div class="card-body pb-0">
            <form action="{{ route('dashboard-package.index') }}" method="get">
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="discount" value="{{ $discount }}">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
	...
	<div class="row">
					...
					<div class="table-responsive">
						<table id="example1" class="table table-stripped">
							...
							<tbody>
								...
								@include('dashboard.package.editModal')
								@include('dashboard.package.deleteModal')
								@endforeach
								@else
								<tr>
        ...
        @include('dashboard.package.addModal')
        @include('dashboard.package.deleteSelectedModal')		
	</div>
@endsection