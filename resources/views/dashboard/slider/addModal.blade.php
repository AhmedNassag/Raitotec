    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('dashboard-slider.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <!--title_ar-->
                    ...
                    <!--add_button-->
                    <div class="form-group">
                        <input type="checkbox" name="add_button" value="1">
