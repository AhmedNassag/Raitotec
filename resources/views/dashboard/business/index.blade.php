...
@section('content')
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
                <h3 class="page-title">{{ trans('main.Business') }}</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ trans('main.Dashboard') }}</a></li>
                    <li class="breadcrumb-item active">{{ trans('main.Business') }}</li>
                </ul>
            </div>
			<div class="col-auto">
	...
	<!-- Search Filter -->
    <div class="card filter-card" id="filter_inputs" @if($title || $from_date || $to_date) style="display:block" @endif>
        <div class="card-body pb-0">
            <form action="{{ route('dashboard-business.index') }}" method="get">
	...
	<div class="row">
				...
				<div class="table-responsive">
					<table id="example1" class="table table-stripped">
						...
						<tbody>
							...
							@include('dashboard.business.editModal')
							@include('dashboard.business.deleteModal')
							@endforeach
							@else
							<tr>
        ...
        @include('dashboard.business.addModal')
        @include('dashboard.business.deleteSelectedModal')		
	</div>
@endsection