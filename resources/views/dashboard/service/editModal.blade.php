    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{ trans('main.Edit') }} {{ trans('main.Service') }}</h4>
                <button type="button" class="close" data-bs-dismiss="modal"><span>&times;</span></button>
            </div>

            <div class="modal-body">
                <form action="{{ route('dashboard-service.update', 'test') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    {{ method_field('patch') }}
                    @csrf
                    <!--first_title_ar-->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="second_title_ar" value="{{ $item->second_title_ar }}" placeholder="{{ trans('main.Second Title') }} {{ trans('main.In Arabic') }}" required>
                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                    </div>
                    <!--second_content_ar-->
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="update_second_content_ar" placeholder="{{trans('main.Second Content') }} {{ trans('main.In Arabic') }}" rows="5" name="second_content_ar">{{ $item->second_content_ar }}</textarea>
                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                    </div>
                    <!--second_title_en-->
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="second_title_en" value="{{ $item->second_title_en }}" placeholder="{{ trans('main.Second Title') }} {{ trans('main.In English') }}" required>
                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                    </div>
                    <!--second_content_en-->
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="update_second_content_en" placeholder="{{trans('main.Second Content') }} {{ trans('main.In English') }}" rows="5" name="second_content_en">{{ $item->second_content_en }}</textarea>
                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                    </div>
                    <!--photo-->
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <img loading="lazy" class="img-thumbnail m-1" src="{{ asset('public/attachments/service/'.$item->photo) }}" alt="{{ $item->photo }}" style="max-width:200px; max-height:200px; !important">
                            </div>
                        </div>
                        @endif
                    </div>
