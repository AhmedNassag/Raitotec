...
<html lang="{{ str_replace('_','-',app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('dashboard-blog.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    @csrf
                                    <!--first_title_ar-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" id="editor_store_first_content_ar" placeholder="{{trans('main.First Content') }} {{ trans('main.In Arabic') }}" rows="5" name="first_content_ar"></textarea>
                                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                                    </div>
                                    <!--first_title_en-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" id="editor_store_first_content_en" placeholder="{{trans('main.First Content') }} {{ trans('main.In English') }}" rows="5" name="first_content_en"></textarea>
                                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                                    </div>
                                    <!--second_title_ar-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" id="editor_store_second_content_ar" placeholder="{{trans('main.Second Content') }} {{ trans('main.In Arabic') }}" rows="5" name="second_content_ar"></textarea>
                                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                                    </div>
                                    <!--second_title_en-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor form-control" id="editor_store_second_content_en" placeholder="{{trans('main.Second Content') }} {{ trans('main.In English') }}" rows="5" name="second_content_en"></textarea>
                                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                                    </div>
                                    <!--meta_description-->
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="meta_description" value="{{ old('meta_description') }}" placeholder="{{ trans('main.Meta Description') }}">
                                        <div class="valid-feedback">{{ trans('main.Looks Good') }}</div>
                                        <div class="invalid-feedback">{{ trans('main.Error Here')}}</div>
                                    </div>
                                    <!--photo-->
        ...
        <script>
            CKEDITOR.ClassicEditor.create(document.getElementById("editor_store_first_content_ar"), {
                toolbar: {
                    items: [
        ...
        <script>
            CKEDITOR.ClassicEditor.create(document.getElementById("editor_store_first_content_en"), {
                toolbar: {
                    items: [
                        'exportPDF', 'exportWord', '|'
                        , 'findAndReplace', 'selectAll', '|'
        ...
        <script>
            CKEDITOR.ClassicEditor.create(document.getElementById("editor_store_second_content_ar"), {
                toolbar: {
                    items: [
                        'exportPDF', 'exportWord', '|'
                        , 'findAndReplace', 'selectAll', '|'
        ...
        <script>
            CKEDITOR.ClassicEditor.create(document.getElementById("editor_store_second_content_en"), {
                toolbar: {
                    items: [
                        'exportPDF', 'exportWord', '|'
                        , 'findAndReplace', 'selectAll', '|'
